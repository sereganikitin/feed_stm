...
# (ExternalId в фиде, id помещения в ProfitBase, kind, FloorsCount дома)
LISTINGS = [
    # ── Продажа (готовый арендный бизнес + Фитнес) ──
    ("16890194",  "16890194", "sale", 3),   # Здание 1 — Велопрокат целиком
    ("16890195",  "16890195", "sale", 4),   # Здание 2 — Офис продаж целиком
    ("11242968",  "11242968", "sale", 4),   # Здание 3 — Йога 2 эт
    ("11242974",  "11242974", "sale", 4),   # Здание 3 — Йога 3 эт
    ("11242998",  "11242998", "sale", 4),   # Здание 3 — Йога 4 эт
    ("13443309",  "13443309", "sale", 1),   # Фитнес (продажа)
    # ── Аренда (торговые площади + Фитнес) ──
    ("15077881",  "15077881", "rent", 2),   # К1П6-2
    ("9841263",   "9841263",  "rent", 2),   # К2П5
    ("11901465",  "11901465", "rent", 3),   # С6П3 — офис 3 эт Велопрокат
    ("11760880",  "11760880", "rent", 2),   # К2П12
    ("9849983",   "9849983",  "rent", 2),   # К3П1
    ("9849988",   "9849988",  "rent", 2),   # К3П6
    ("9849991",   "9849991",  "rent", 2),   # К3П9
    ("11770818",  "11770818", "rent", 2),   # К3П11
    ("13443309R", "13443309", "rent", 1),   # Фитнес (аренда) — отдельный ExternalId
]
...
def refresh():
    ...
    n_sale = n_rent = 0
    for ext_id, pid, kind, floors in LISTINGS:
        it = _prop(token, pid)
        ...
        if kind == "rent":
            ...
            n_sale += 1
        # Назначение
        naz = _cf(it, NAZ_FIELD) or "Свободное назначение"
